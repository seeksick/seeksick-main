...
**실시간 감정 분석 + ChatGPT AI 상담사**가 통합된 웹 버전이 추가되었습니다!
...
- ✅ 실시간 감정 분석 (5초 간격 Late Fusion)
- ✅ ChatGPT 통합 공감적 AI 상담사
- ✅ 반응형 디자인 (데스크톱, 모바일)
- ✅ 5가지 감정 확률 실시간 표시

**📚 상세 가이드:** [`QUICKSTART.md`](QUICKSTART.md) | [`WEB_APP_GUIDE.md`](WEB_APP_GUIDE.md)
